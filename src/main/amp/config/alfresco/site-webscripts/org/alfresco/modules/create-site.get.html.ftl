...
<div id="${el}-dialog" class="create-site">
   <div class="hd">
      <@markup id="title">Create Department</@markup>
   </div>
   <div class="bd">
      <form id="${el}-form" method="POST" action="">
         ...
         <@markup id="fields">
            ...
            <div class="yui-gd" style="display:none;">
               ...
               <div class="yui-u">
                  <input id="${el}-isPublic" type="radio" tabindex="0" name="-" /> <label for="${el}-isPublic">${msg("label.isPublic")}</label><br />
                  <div class="moderated">
            ...
            <div class="yui-gd" style="display:none;">
               ...
               <div class="yui-u">
                  <input id="${el}-isPrivate" type="radio" checked="checked" tabindex="0" name="-" /> <label for="${el}-isPrivate">${msg("label.isPrivate")}SS</label>
               </div>
            </div>
         </@markup>
