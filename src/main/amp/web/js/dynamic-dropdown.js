(function(SOP) {
	...
	SOP.DynamicDropdown = function(htmlId)
	{
		var componentName = "SOP.DynamicDropdown";
		var returnObject = SOP.DynamicDropdown.superclass.constructor.call(this, componentName, htmlId, "SOP.DynamicDropdown"); 
		
		return returnObject;
	};
	
	YAHOO.extend(SOP.DynamicDropdown, Alfresco.component.Base,
	{
		options : {
			itemId : "",
			picklistName : "",
		...
		loadValues : function() {
            ...
            {
               url: Alfresco.constants.PROXY_URI + 'com/sop/picklist/picklist?includeBlankItem=true&name='+this.options.picklistName+'&itemId='+this.options.itemId+dependencyQuery+'&level='+this.options.level,
               method: "GET",
