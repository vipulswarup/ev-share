...
define(["dojo/_base/declare",
        ...
        "dojo/text!./templates/EvShareFooter.html",
        "alfresco/core/Core",
        "dojo/_base/lang",
        "dojo/dom-class",
        "dojo/dom-construct"], 
   ...
   return declare([_WidgetBase, _TemplatedMixin, _SemanticWrapperMixin, AlfCore], {
       ...
       * @instance
       * @type {object[]}
       * @default [{i18nFile: "./i18n/EvStickyFooter.properties"}]
       */
      i18nRequirements: [{i18nFile: "./i18n/EvShareFooter.properties"}],
       ...
       * @type {object[]}
       * @default [{cssFile:"./css/EvShareFooter.css"},{cssFile:"/modules/about-share.css"}]
       */
      cssRequirements: [{cssFile:"./css/EvShareFooter.css"},
       ...
       * @instance
       */
      postMixInProperties: function eisenvault_footer_EvShareFooter__postMixInProperties() {
         ...
         if (this.logoImageSrc == "alfresco-share-logo-enterprise.png" ||
             ...
             this.logoImageSrc == "alfresco-share-logo.png")
         {
            this.logoImageSrc = require.toUrl("eisenvault/footer") + "/css/images/" + this.logoImageSrc;
         }
         else
         {
            this.logoImageSrc = require.toUrl("eisenvault/footer") + "/css/images/" + this.logoImageSrc;
       ...
       * @instance
       */
      postCreate: function alfresco_footer_EvShareFooter__postCreate() {
