/**
 * Extended from onActionSimpleRepoAction on actions.js to add waiting popup by Raghav Bhardwaj 20-10-15
 */
(function() {
	YAHOO.Bubbling.fire("registerAction", {
		actionName : "waitmessageDialog",
		fn: function waitmessageDialog(record, owner) {
